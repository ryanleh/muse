    ...
    P::Field: AuthShare,
{
    ...
    pub fn server_cds<R: Read + Send + Unpin, W: Write + Send + Unpin, RNG: CryptoRng + RngCore>(
        ...
        sfhe: &ServerFHE,
        mut mpc: ServerMPC<P::Field>,
        mut mpc_2: ServerMPC<P::Field>,
        mut mpc_3: ServerMPC<P::Field>,
        layer_sizes: &[usize],
    ...
    pub fn client_cds<R: Read + Send + Unpin, W: Write + Send + Unpin, RNG: CryptoRng + RngCore>(
        ...
        writer_3: &mut IMuxAsync<W>,
        cfhe: &ClientFHE,
        mut mpc: ClientMPC<P::Field>,
        mut mpc_2: ClientMPC<P::Field>,
        mut mpc_3: ClientMPC<P::Field>,
        layer_sizes: &[usize],
        out_mac_shares: &[P::Field],
        out_shares: &[P::Field],
        inp_mac_shares: &[P::Field],
